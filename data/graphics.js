...
shelltrap:{
anim:function(scene,_ref176){var attacker=_ref176[0],defenders=_ref176.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref193){var attacker=_ref193[0],defenders=_ref193.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
bulldoze:{
anim:function(scene,_ref194){var attacker=_ref194[0],defenders=_ref194.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0},
...
hypervoice:{
anim:function(scene,_ref216){var attacker=_ref216[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
poweroutage:{
anim:function(scene,_ref217){var attacker=_ref217[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref218){var attacker=_ref218[0],defenders=_ref218.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref219){var attacker=_ref219[0],defenders=_ref219.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref220){var attacker=_ref220[0],defenders=_ref220.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref245){var attacker=_ref245[0],defenders=_ref245.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref253){var attacker=_ref253[0],defenders=_ref253.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref266){var attacker=_ref266[0],defenders=_ref266.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref268){var attacker=_ref268[0],defenders=_ref268.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref279){var attacker=_ref279[0],defenders=_ref279.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref290){var attacker=_ref290[0];
...
residualAnim:function(scene,_ref291){var attacker=_ref291[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref316){var attacker=_ref316[0],defenders=_ref316.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref318){var attacker=_ref318[0],defenders=_ref318.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref320){var attacker=_ref320[0],defenders=_ref320.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref321){var attacker=_ref321[0],defenders=_ref321.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref322){var attacker=_ref322[0],defenders=_ref322.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref325){var attacker=_ref325[0],defenders=_ref325.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);
...
mistyexplosion:{
anim:function(scene,_ref364){var attacker=_ref364[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref369){var attacker=_ref369[0],defenders=_ref369.slice(1);
...
shadowdance:{
anim:function(scene,_ref408){var attacker=_ref408[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref432){var attacker=_ref432[0],defenders=_ref432.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref453){var attacker=_ref453[0],defenders=_ref453.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref455){var attacker=_ref455[0],defenders=_ref455.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref486){var attacker=_ref486[0],defenders=_ref486.slice(1);
attacker.anim({x:attacker.x-10,time:300});
...
unifiedupsurge:{
anim:function(scene,_ref487){var attacker=_ref487[0],defenders=_ref487.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
