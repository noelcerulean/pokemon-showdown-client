...
shelltrap:{
anim:function(scene,_ref165){var attacker=_ref165[0],defenders=_ref165.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref180){var attacker=_ref180[0],defenders=_ref180.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
bulldoze:{
anim:function(scene,_ref181){var attacker=_ref181[0],defenders=_ref181.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0},
...
hypervoice:{
anim:function(scene,_ref200){var attacker=_ref200[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref201){var attacker=_ref201[0],defenders=_ref201.slice(1);for(var _i6=0;_i6<
...
heatwave:{
anim:function(scene,_ref202){var attacker=_ref202[0],defenders=_ref202.slice(1);for(var _i7=0;_i7<
...
thousandarrows:{
anim:function(scene,_ref247){var attacker=_ref247[0],defenders=_ref247.slice(1);for(var _i11=0;_i11<
...
thousandwaves:{
anim:function(scene,_ref248){var attacker=_ref248[0],defenders=_ref248.slice(1);for(var _i12=0;_i12<
...
wish:{
anim:function(scene,_ref268){var attacker=_ref268[0];
...
residualAnim:function(scene,_ref269){var attacker=_ref269[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref293){var attacker=_ref293[0],defenders=_ref293.slice(1);for(var _i14=0;_i14<
...
muddywater:{
anim:function(scene,_ref295){var attacker=_ref295[0],defenders=_ref295.slice(1);for(var _i15=0;_i15<
...
lavaplume:{
anim:function(scene,_ref297){var attacker=_ref297[0],defenders=_ref297.slice(1);for(var _i16=0;_i16<
...
dragonenergy:{
anim:function(scene,_ref298){var attacker=_ref298[0],defenders=_ref298.slice(1);for(var _i17=0;_i17<
...
eruption:{
anim:function(scene,_ref299){var attacker=_ref299[0],defenders=_ref299.slice(1);for(var _i18=0;_i18<
...
waterspout:{
anim:function(scene,_ref300){var attacker=_ref300[0],defenders=_ref300.slice(1);for(var _i19=0;_i19<
...
glaciallance:{
anim:function(scene,_ref307){var attacker=_ref307[0],defenders=_ref307.slice(1);
...
mistyexplosion:{
anim:function(scene,_ref337){var attacker=_ref337[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
shadowrave:{
anim:function(scene,_ref401){var attacker=_ref401[0],defenders=_ref401.slice(1);for(var _i28=0;_i28<
...
shadowwave:{
anim:function(scene,_ref421){var attacker=_ref421[0],defenders=_ref421.slice(1);for(var _i29=0;_i29<
