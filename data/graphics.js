...
glaciallance:{
anim:function(scene,_ref352){var attacker=_ref352[0],defenders=_ref352.slice(1);
scene.backgroundEffect("url('https://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i24=0;_i24<
...
darkvoid:{
anim:function(scene,_ref371){var attacker=_ref371[0],defenders=_ref371.slice(1);for(var _i25=0;_i25<
...
mistyexplosion:{
anim:function(scene,_ref386){var attacker=_ref386[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
scene.backgroundEffect('#FF99FF',700,0.3);for(var _i26=0;_i26<

defenders.length;_i26++){var _defender14=defenders[_i26];
_defender14.delay(350);
_defender14.anim({
...
scene.backgroundEffect('#000000',1300,0.3);for(var _i27=0;_i27<

defenders.length;_i27++){var _defender15=defenders[_i27];
_defender15.delay(700);
_defender15.anim({
z:_defender15.behind(10),
time:100},
'swing');
_defender15.anim({
time:200},
...
astralbarrage:{
anim:function(scene,_ref425){var attacker=_ref425[0],defenders=_ref425.slice(1);
scene.backgroundEffect('#000000',600,0.6);
scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)',1100,0.6,600);
...
z:attacker.z,
time:250},
'decel');for(var _i28=0;_i28<
defenders.length;_i28++){var defender=defenders[_i28];
var xstep=(defender.x-attacker.x)/5;
var ystep=(defender.x-200-attacker.x)/5;
var zstep=(defender.z-attacker.z)/5;
for(var i=0;i<5;i++){
...
attacker.anim({
opacity:1,
time:200});for(var _i29=0;_i29<

defenders.length;_i29++){var _defender16=defenders[_i29];
_defender16.delay(1825);
_defender16.anim({
z:_defender16.behind(5),
time:75},
'swing');
_defender16.anim({
time:75},
...
'swing');
_defender16.anim({
z:_defender16.behind(15),
time:75,
opacity:0},
'swing');
_defender16.delay(400);
_defender16.anim({
time:200},
'swing');
}
...
scene.backgroundEffect('linear-gradient(#46AF71 20%, #1170F0)',1600,0.4,300);for(var _i30=0;_i30<

defenders.length;_i30++){var _defender17=defenders[_i30];
_defender17.delay(2075);
_defender17.anim({
x:_defender17.x-30,
time:75});
...
for(var _i31=0;_i31<6;_i31++){
scene.showEffect('wisp',{
x:attacker.leftof(-50)+xstep*(_i31+1),
y:attacker.y+275+ystep*(_i31+1),
z:attacker.behind(-150)+zstep*(_i31+1),
scale:1.3,
opacity:1,
time:5*_i31+900},
{
x:defender.leftof(-50)+xstep*(_i31+1),
...
shadowdance:{
anim:function(scene,_ref444){var attacker=_ref444[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowdetonation:{
anim:function(scene,_ref447){var attacker=_ref447[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowfireball3',{
x:attacker.x+40,
y:attacker.y,
...
shadowfountain:{
anim:function(scene,_ref457){var attacker=_ref457[0];
...
shadowhubris:{
anim:function(scene,_ref467){var attacker=_ref467[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowrave:{
anim:function(scene,_ref480){var attacker=_ref480[0],defenders=_ref480.slice(1);for(var _i33=0;_i33<
defenders.length;_i33++){var defender=defenders[_i33];
defender.delay(125);
defender.anim({
z:defender.behind(5),
time:75},
...
shadowroulette:{
anim:function(scene,_ref484){var attacker=_ref484[0];
scene.backgroundEffect('#110131',700,0.7);
...
shadowscheme:{
anim:function(scene,_ref487){var attacker=_ref487[0];
scene.backgroundEffect('#110131',700,0.7);
...
shadowvelocity:{
anim:function(scene,_ref507){var attacker=_ref507[0];
scene.backgroundEffect('#110131',1100,0.7);
attacker.anim({x:attacker.x-10,time:200});
attacker.anim({x:attacker.x+10,time:300});
attacker.anim({x:attacker.x-20,time:150});
...
shadowwave:{
anim:function(scene,_ref510){var attacker=_ref510[0],defenders=_ref510.slice(1);for(var _i34=0;_i34<
defenders.length;_i34++){var _defender18=defenders[_i34];
_defender18.delay(125);
_defender18.anim({
z:_defender18.behind(5),
time:75},
'swing');
_defender18.anim({
time:75},
...
shadowwreckage:{
anim:function(scene,_ref513){var attacker=_ref513[0],defenders=_ref513.slice(1);
...
attacker.anim({
y:attacker.y,
time:100});for(var _i35=0;_i35<


defenders.length;_i35++){var defender=defenders[_i35];
defender.delay(275);
defender.anim({
y:defender.y-10,
time:75});
...
scene.showEffect('colorball2',{
x:defender.x-150+xstep*(_i36+1),
y:defender.y+200+ystep*(_i36+1),
z:defender.z+zstep*(_i36+1),
scale:0.6,
opacity:0.7,
time:40*_i36+100},
{
...
scene.showEffect('colorball2',{
x:attacker.x-150+xstep*(_i43+1),
y:attacker.y+200+ystep*(_i43+1),
z:attacker.z+zstep*(_i43+1),
scale:0.6,
opacity:0.7,
time:40*_i43+100},
{
...
scene.showEffect('poisonwisp',{
x:defender.x-150+xstep*(_i50+1),
y:defender.y+200+ystep*(_i50+1),
z:defender.z+zstep*(_i50+1),
scale:0.6,
opacity:0.7,
time:40*_i50+100},
{
...
scene.showEffect('electroball',{
x:attacker.x-150+xstep*(_i57+1),
y:attacker.y+200+ystep*(_i57+1),
z:attacker.z+zstep*(_i57+1),
scale:0.6,
opacity:0.7,
time:40*_i57+100},
{
...
clangoroussoulblaze:{
anim:function(scene,_ref546){var attacker=_ref546[0],defenders=_ref546.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
...
attacker.anim({
opacity:1,
time:200});for(var _i64=0;_i64<

defenders.length;_i64++){var _defender19=defenders[_i64];
_defender19.delay(1825);
_defender19.anim({
...
'swing');
_defender19.anim({
z:_defender19.behind(15),
time:75,
opacity:0},
'swing');
_defender19.delay(400);
_defender19.anim({
time:200},
'swing');
}
...
unifiedupsurge:{
anim:function(scene,_ref547){var attacker=_ref547[0],defenders=_ref547.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
