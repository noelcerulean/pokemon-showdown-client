...
shelltrap:{
anim:function(scene,_ref188){var attacker=_ref188[0],defenders=_ref188.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref208){var attacker=_ref208[0],defenders=_ref208.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
hypervoice:{
anim:function(scene,_ref232){var attacker=_ref232[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref234){var attacker=_ref234[0],defenders=_ref234.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref235){var attacker=_ref235[0],defenders=_ref235.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref236){var attacker=_ref236[0],defenders=_ref236.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref262){var attacker=_ref262[0],defenders=_ref262.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref271){var attacker=_ref271[0],defenders=_ref271.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref284){var attacker=_ref284[0],defenders=_ref284.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref286){var attacker=_ref286[0],defenders=_ref286.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref287){var attacker=_ref287[0],defenders=_ref287.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref298){var attacker=_ref298[0],defenders=_ref298.slice(1);for(var _i14=0;_i14<
...
surf:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i15=0;_i15<
...
diffusionwave:{
anim:function(scene,_ref339){var attacker=_ref339[0],defenders=_ref339.slice(1);for(var _i16=0;_i16<
...
muddywater:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_ref341.slice(1);for(var _i17=0;_i17<
...
lavaplume:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i18=0;_i18<
...
dragonenergy:{
anim:function(scene,_ref346){var attacker=_ref346[0],defenders=_ref346.slice(1);for(var _i19=0;_i19<
...
eruption:{
anim:function(scene,_ref347){var attacker=_ref347[0],defenders=_ref347.slice(1);for(var _i20=0;_i20<
...
waterspout:{
anim:function(scene,_ref348){var attacker=_ref348[0],defenders=_ref348.slice(1);for(var _i21=0;_i21<
...
proliferation:{
anim:function(scene,_ref349){var attacker=_ref349[0],defenders=_ref349.slice(1);for(var _i22=0;_i22<
...
fallout:{
anim:function(scene,_ref350){var attacker=_ref350[0],defenders=_ref350.slice(1);for(var _i23=0;_i23<
...
icefall:{
anim:function(scene,_ref351){var attacker=_ref351[0],defenders=_ref351.slice(1);for(var _i24=0;_i24<
...
glaciallance:{
anim:function(scene,_ref358){var attacker=_ref358[0],defenders=_ref358.slice(1);
...
darkvoid:{
anim:function(scene,_ref377){var attacker=_ref377[0],defenders=_ref377.slice(1);for(var _i26=0;_i26<
...
mistyexplosion:{
anim:function(scene,_ref392){var attacker=_ref392[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref398){var attacker=_ref398[0],defenders=_ref398.slice(1);
...
brutalswing:{
anim:function(scene,_ref417){var attacker=_ref417[0],defenders=_ref417.slice(1);
...
coreenforcer:{
anim:function(scene,_ref437){var attacker=_ref437[0],defenders=_ref437.slice(1);
...
shadowdance:{
anim:function(scene,_ref450){var attacker=_ref450[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowdestruction:{
anim:function(scene,_ref452){var attacker=_ref452[0],defender=_ref452[1];
scene.backgroundEffect('#110131',700,0.7);
...
shadowdetonation:{
anim:function(scene,_ref453){var attacker=_ref453[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowfireball3',{
x:attacker.x+40,
y:attacker.y,
...
shadowfountain:{
anim:function(scene,_ref463){var attacker=_ref463[0];
...
shadowhubris:{
anim:function(scene,_ref473){var attacker=_ref473[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowinversion:{
anim:function(scene,_ref475){var attacker=_ref475[0],defender=_ref475[1];
var xf=[1,-1,1,-1];
var yf=[1,-1,-1,1];
var xf2=[1,0,-1,0];
var yf2=[0,1,0,-1];
...
shadowmoon:{
anim:function(scene,_ref479){var attacker=_ref479[0];
...
shadowglaze:{
anim:function(scene,_ref480){var attacker=_ref480[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/shadow-moon.png')",800,0.8);
scene.showEffect('shine',{
x:attacker.x+40,
y:attacker.y-40,
...
shadowpanic:{
anim:function(scene,_ref481){var attacker=_ref481[0],defender=_ref481[1];
...
shadowpivot:{
anim:function(scene,_ref482){var attacker=_ref482[0],defender=_ref482[1];
scene.backgroundEffect('#110131',900,0.7);
scene.showEffect('shadowwisp',{
x:defender.x,
y:defender.y+80,
...
shadowrave:{
anim:function(scene,_ref486){var attacker=_ref486[0],defenders=_ref486.slice(1);for(var _i34=0;_i34<
...
shadowreset:{
anim:function(scene,_ref488){var attacker=_ref488[0],defender=_ref488[1];
var xf=[1,-1,1,-1];
var yf=[1,-1,-1,1];
var xf2=[1,0,-1,0];
var yf2=[0,1,0,-1];
...
shadowroulette:{
anim:function(scene,_ref490){var attacker=_ref490[0];
scene.backgroundEffect('#110131',700,0.7);
...
shadowseed:{
anim:function(scene,_ref492){var attacker=_ref492[0],defender=_ref492[1];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball2',{
x:attacker.x,
y:attacker.y,
...
shadowscheme:{
anim:function(scene,_ref493){var attacker=_ref493[0];
scene.backgroundEffect('#110131',700,0.7);
...
shadowshatter:{
anim:function(scene,_ref495){var attacker=_ref495[0],defender=_ref495[1];
scene.backgroundEffect('#110131',1000,0.7);
scene.showEffect('shadowrightchop',{
x:defender.leftof(30),
y:defender.y+50,
...
shadowvelocity:{
anim:function(scene,_ref513){var attacker=_ref513[0];
scene.backgroundEffect('#110131',1100,0.7);
attacker.anim({x:attacker.x-10,time:200});
attacker.anim({x:attacker.x+10,time:300});
attacker.anim({x:attacker.x-20,time:150});
...
shadowvolley:{
anim:function(scene,_ref515){var attacker=_ref515[0],defender=_ref515[1];
...
shadowwave:{
anim:function(scene,_ref516){var attacker=_ref516[0],defenders=_ref516.slice(1);for(var _i35=0;_i35<
...
shadowwhiteout:{
anim:function(scene,_ref518){var attacker=_ref518[0],defender=_ref518[1];
scene.backgroundEffect('#110131',900,0.7);
...
shadowwreckage:{
anim:function(scene,_ref519){var attacker=_ref519[0],defenders=_ref519.slice(1);
...
shadowfire:{
anim:function(scene,_ref521){var attacker=_ref521[0],defender=_ref521[1];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowfireball',{
x:attacker.x,
y:attacker.y,
...
clangoroussoulblaze:{
anim:function(scene,_ref553){var attacker=_ref553[0],defenders=_ref553.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
...
unifiedupsurge:{
anim:function(scene,_ref554){var attacker=_ref554[0],defenders=_ref554.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
...
anim:function(scene,_ref556){var attacker=_ref556[0],defender=_ref556[1];
...
searingsunrazesmash:{
anim:function(scene,_ref557){var attacker=_ref557[0],defender=_ref557[1];
var xstep=(defender.x-attacker.x)/5;
var ystep=(defender.x-200-attacker.x)/5;
var zstep=(defender.z-attacker.z)/5;
