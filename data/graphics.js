...
hypervoice:{
anim:function(scene,_ref207){var attacker=_ref207[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
poweroutage:{
anim:function(scene,_ref208){var attacker=_ref208[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref209){var attacker=_ref209[0],defenders=_ref209.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref210){var attacker=_ref210[0],defenders=_ref210.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref211){var attacker=_ref211[0],defenders=_ref211.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref236){var attacker=_ref236[0],defenders=_ref236.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref244){var attacker=_ref244[0],defenders=_ref244.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref257){var attacker=_ref257[0],defenders=_ref257.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref259){var attacker=_ref259[0],defenders=_ref259.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref260){var attacker=_ref260[0],defenders=_ref260.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_ref270.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref281){var attacker=_ref281[0];
...
residualAnim:function(scene,_ref282){var attacker=_ref282[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref307){var attacker=_ref307[0],defenders=_ref307.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref309){var attacker=_ref309[0],defenders=_ref309.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref311){var attacker=_ref311[0],defenders=_ref311.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref312){var attacker=_ref312[0],defenders=_ref312.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref313){var attacker=_ref313[0],defenders=_ref313.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref314){var attacker=_ref314[0],defenders=_ref314.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref315){var attacker=_ref315[0],defenders=_ref315.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref316){var attacker=_ref316[0],defenders=_ref316.slice(1);for(var _i22=0;_i22<
...
darkvoid:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref355){var attacker=_ref355[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
brutalswing:{
anim:function(scene,_ref378){var attacker=_ref378[0],defenders=_ref378.slice(1);
...
shadowdance:{
anim:function(scene,_ref399){var attacker=_ref399[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowhubris:{
anim:function(scene,_ref414){var attacker=_ref414[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowglaze:{
anim:function(scene,_ref418){var attacker=_ref418[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/shadow-moon.png')",800,0.8);
scene.showEffect('shine',{
x:attacker.x+40,
y:attacker.y-40,
...
shadowrave:{
anim:function(scene,_ref423){var attacker=_ref423[0],defenders=_ref423.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref444){var attacker=_ref444[0],defenders=_ref444.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref446){var attacker=_ref446[0],defenders=_ref446.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref477){var attacker=_ref477[0],defenders=_ref477.slice(1);
attacker.anim({x:attacker.x-10,time:300});
...
unifiedupsurge:{
anim:function(scene,_ref478){var attacker=_ref478[0],defenders=_ref478.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
