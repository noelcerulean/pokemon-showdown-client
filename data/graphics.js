...
boomburst:{
anim:function(scene,_ref221){var attacker=_ref221[0],defenders=_ref221.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref222){var attacker=_ref222[0],defenders=_ref222.slice(1);for(var _i7=0;_i7<
...
icywind:{
anim:function(scene,_ref248){var attacker=_ref248[0],defenders=_ref248.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref256){var attacker=_ref256[0],defenders=_ref256.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref271){var attacker=_ref271[0],defenders=_ref271.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref272){var attacker=_ref272[0],defenders=_ref272.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref282){var attacker=_ref282[0],defenders=_ref282.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref293){var attacker=_ref293[0];
...
residualAnim:function(scene,_ref294){var attacker=_ref294[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref295){var attacker=_ref295[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref296){var attacker=_ref296[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_ref319.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref321){var attacker=_ref321[0],defenders=_ref321.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref325){var attacker=_ref325[0],defenders=_ref325.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_ref326.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref327){var attacker=_ref327[0],defenders=_ref327.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_ref328.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref335){var attacker=_ref335[0],defenders=_ref335.slice(1);
...
darkvoid:{
anim:function(scene,_ref354){var attacker=_ref354[0],defenders=_ref354.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref367){var attacker=_ref367[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
astralbarrage:{
anim:function(scene,_ref404){var attacker=_ref404[0],defenders=_ref404.slice(1);
scene.backgroundEffect('#000000',600,0.6);
scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)',1100,0.6,600);
...
shadowdance:{
anim:function(scene,_ref411){var attacker=_ref411[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref435){var attacker=_ref435[0],defenders=_ref435.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref456){var attacker=_ref456[0],defenders=_ref456.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref458){var attacker=_ref458[0],defenders=_ref458.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref490){var attacker=_ref490[0],defenders=_ref490.slice(1);
attacker.anim({x:attacker.x-10,time:300});
