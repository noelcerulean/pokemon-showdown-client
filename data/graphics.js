...
dragonenergy:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref339){var attacker=_ref339[0],defenders=_ref339.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref340){var attacker=_ref340[0],defenders=_ref340.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_ref341.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref349){var attacker=_ref349[0],defenders=_ref349.slice(1);
...
darkvoid:{
anim:function(scene,_ref368){var attacker=_ref368[0],defenders=_ref368.slice(1);for(var _i24=0;_i24<
...
petalblizzard:{
anim:function(scene,_ref387){var attacker=_ref387[0],defenders=_ref387.slice(1);
...
brutalswing:{
anim:function(scene,_ref405){var attacker=_ref405[0],defenders=_ref405.slice(1);
...
shadowdance:{
anim:function(scene,_ref438){var attacker=_ref438[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref474){var attacker=_ref474[0],defenders=_ref474.slice(1);for(var _i32=0;_i32<
...
shadowvelocity:{
anim:function(scene,_ref501){var attacker=_ref501[0];
scene.backgroundEffect('#110131',1100,0.7);
attacker.anim({x:attacker.x-10,time:200});
attacker.anim({x:attacker.x+10,time:300});
attacker.anim({x:attacker.x-20,time:150});
...
shadowwave:{
anim:function(scene,_ref504){var attacker=_ref504[0],defenders=_ref504.slice(1);for(var _i33=0;_i33<
...
shadowwreckage:{
anim:function(scene,_ref507){var attacker=_ref507[0],defenders=_ref507.slice(1);
...
unifiedupsurge:{
anim:function(scene,_ref541){var attacker=_ref541[0],defenders=_ref541.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
