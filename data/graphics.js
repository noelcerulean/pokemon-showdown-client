...
shelltrap:{
anim:function(scene,_ref186){var attacker=_ref186[0],defenders=_ref186.slice(1);for(var _i3=0;_i3<
...
poweroutage:{
anim:function(scene,_ref231){var attacker=_ref231[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref232){var attacker=_ref232[0],defenders=_ref232.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref233){var attacker=_ref233[0],defenders=_ref233.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref234){var attacker=_ref234[0],defenders=_ref234.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref260){var attacker=_ref260[0],defenders=_ref260.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref282){var attacker=_ref282[0],defenders=_ref282.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref284){var attacker=_ref284[0],defenders=_ref284.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref285){var attacker=_ref285[0],defenders=_ref285.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref296){var attacker=_ref296[0],defenders=_ref296.slice(1);for(var _i14=0;_i14<
...
surf:{
anim:function(scene,_ref334){var attacker=_ref334[0],defenders=_ref334.slice(1);for(var _i15=0;_i15<
...
diffusionwave:{
anim:function(scene,_ref335){var attacker=_ref335[0],defenders=_ref335.slice(1);for(var _i16=0;_i16<
...
muddywater:{
anim:function(scene,_ref337){var attacker=_ref337[0],defenders=_ref337.slice(1);for(var _i17=0;_i17<
...
lavaplume:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_ref341.slice(1);for(var _i18=0;_i18<
...
dragonenergy:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i19=0;_i19<
...
eruption:{
anim:function(scene,_ref343){var attacker=_ref343[0],defenders=_ref343.slice(1);for(var _i20=0;_i20<
...
waterspout:{
anim:function(scene,_ref344){var attacker=_ref344[0],defenders=_ref344.slice(1);for(var _i21=0;_i21<
...
proliferation:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i22=0;_i22<
...
fallout:{
anim:function(scene,_ref346){var attacker=_ref346[0],defenders=_ref346.slice(1);for(var _i23=0;_i23<
...
icefall:{
anim:function(scene,_ref347){var attacker=_ref347[0],defenders=_ref347.slice(1);for(var _i24=0;_i24<
...
glaciallance:{
anim:function(scene,_ref354){var attacker=_ref354[0],defenders=_ref354.slice(1);
...
darkvoid:{
anim:function(scene,_ref373){var attacker=_ref373[0],defenders=_ref373.slice(1);for(var _i26=0;_i26<
...
mistyexplosion:{
anim:function(scene,_ref388){var attacker=_ref388[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref394){var attacker=_ref394[0],defenders=_ref394.slice(1);
...
astralbarrage:{
anim:function(scene,_ref427){var attacker=_ref427[0],defenders=_ref427.slice(1);
scene.backgroundEffect('#000000',600,0.6);
scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)',1100,0.6,600);
...
shadowdance:{
anim:function(scene,_ref446){var attacker=_ref446[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowdetonation:{
anim:function(scene,_ref449){var attacker=_ref449[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowfireball3',{
x:attacker.x+40,
y:attacker.y,
...
shadowfountain:{
anim:function(scene,_ref459){var attacker=_ref459[0];
...
shadowhubris:{
anim:function(scene,_ref469){var attacker=_ref469[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowglaze:{
anim:function(scene,_ref476){var attacker=_ref476[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/shadow-moon.png')",800,0.8);
scene.showEffect('shine',{
x:attacker.x+40,
y:attacker.y-40,
...
shadowrave:{
anim:function(scene,_ref482){var attacker=_ref482[0],defenders=_ref482.slice(1);for(var _i34=0;_i34<
...
shadowroulette:{
anim:function(scene,_ref486){var attacker=_ref486[0];
scene.backgroundEffect('#110131',700,0.7);
...
shadowscheme:{
anim:function(scene,_ref489){var attacker=_ref489[0];
scene.backgroundEffect('#110131',700,0.7);
...
shadowvelocity:{
anim:function(scene,_ref509){var attacker=_ref509[0];
scene.backgroundEffect('#110131',1100,0.7);
attacker.anim({x:attacker.x-10,time:200});
attacker.anim({x:attacker.x+10,time:300});
attacker.anim({x:attacker.x-20,time:150});
...
shadowwave:{
anim:function(scene,_ref512){var attacker=_ref512[0],defenders=_ref512.slice(1);for(var _i35=0;_i35<
...
shadowwreckage:{
anim:function(scene,_ref515){var attacker=_ref515[0],defenders=_ref515.slice(1);
