...
prepareAnim:function(scene,_ref85){var attacker=_ref85[0],defender=_ref85[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300},
...
shelltrap:{
anim:function(scene,_ref167){var attacker=_ref167[0],defenders=_ref167.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref182){var attacker=_ref182[0],defenders=_ref182.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
hypervoice:{
anim:function(scene,_ref203){var attacker=_ref203[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref204){var attacker=_ref204[0],defenders=_ref204.slice(1);for(var _i6=0;_i6<
...
heatwave:{
anim:function(scene,_ref205){var attacker=_ref205[0],defenders=_ref205.slice(1);for(var _i7=0;_i7<
...
thousandarrows:{
anim:function(scene,_ref251){var attacker=_ref251[0],defenders=_ref251.slice(1);for(var _i11=0;_i11<
...
thousandwaves:{
anim:function(scene,_ref252){var attacker=_ref252[0],defenders=_ref252.slice(1);for(var _i12=0;_i12<
...
wish:{
anim:function(scene,_ref272){var attacker=_ref272[0];
...
residualAnim:function(scene,_ref273){var attacker=_ref273[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref274){var attacker=_ref274[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref275){var attacker=_ref275[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref297){var attacker=_ref297[0],defenders=_ref297.slice(1);for(var _i14=0;_i14<
...
muddywater:{
anim:function(scene,_ref299){var attacker=_ref299[0],defenders=_ref299.slice(1);for(var _i15=0;_i15<
...
lavaplume:{
anim:function(scene,_ref301){var attacker=_ref301[0],defenders=_ref301.slice(1);for(var _i16=0;_i16<
...
dragonenergy:{
anim:function(scene,_ref302){var attacker=_ref302[0],defenders=_ref302.slice(1);for(var _i17=0;_i17<
...
eruption:{
anim:function(scene,_ref303){var attacker=_ref303[0],defenders=_ref303.slice(1);for(var _i18=0;_i18<
...
waterspout:{
anim:function(scene,_ref304){var attacker=_ref304[0],defenders=_ref304.slice(1);for(var _i19=0;_i19<
...
glaciallance:{
anim:function(scene,_ref311){var attacker=_ref311[0],defenders=_ref311.slice(1);
...
darkvoid:{
anim:function(scene,_ref330){var attacker=_ref330[0],defenders=_ref330.slice(1);for(var _i21=0;_i21<
...
mistyexplosion:{
anim:function(scene,_ref341){var attacker=_ref341[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
brutalswing:{
anim:function(scene,_ref364){var attacker=_ref364[0],defenders=_ref364.slice(1);
...
shadowdance:{
anim:function(scene,_ref385){var attacker=_ref385[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref405){var attacker=_ref405[0],defenders=_ref405.slice(1);for(var _i28=0;_i28<
...
shadowwave:{
anim:function(scene,_ref425){var attacker=_ref425[0],defenders=_ref425.slice(1);for(var _i29=0;_i29<
