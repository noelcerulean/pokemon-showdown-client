...
shelltrap:{
anim:function(scene,_ref177){var attacker=_ref177[0],defenders=_ref177.slice(1);for(var _i3=0;_i3<
...
boomburst:{
anim:function(scene,_ref219){var attacker=_ref219[0],defenders=_ref219.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref220){var attacker=_ref220[0],defenders=_ref220.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref221){var attacker=_ref221[0],defenders=_ref221.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref246){var attacker=_ref246[0],defenders=_ref246.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref254){var attacker=_ref254[0],defenders=_ref254.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref267){var attacker=_ref267[0],defenders=_ref267.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_ref270.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref280){var attacker=_ref280[0],defenders=_ref280.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref291){var attacker=_ref291[0];
...
residualAnim:function(scene,_ref292){var attacker=_ref292[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref317){var attacker=_ref317[0],defenders=_ref317.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_ref319.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref321){var attacker=_ref321[0],defenders=_ref321.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref322){var attacker=_ref322[0],defenders=_ref322.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref325){var attacker=_ref325[0],defenders=_ref325.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_ref326.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref333){var attacker=_ref333[0],defenders=_ref333.slice(1);
...
darkvoid:{
anim:function(scene,_ref352){var attacker=_ref352[0],defenders=_ref352.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref365){var attacker=_ref365[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
shadowdance:{
anim:function(scene,_ref409){var attacker=_ref409[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref433){var attacker=_ref433[0],defenders=_ref433.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref454){var attacker=_ref454[0],defenders=_ref454.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref456){var attacker=_ref456[0],defenders=_ref456.slice(1);
