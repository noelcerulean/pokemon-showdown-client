...
lavaplume:{
anim:function(scene,_ref327){var attacker=_ref327[0],defenders=_ref327.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_ref328.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref329){var attacker=_ref329[0],defenders=_ref329.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref330){var attacker=_ref330[0],defenders=_ref330.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref331){var attacker=_ref331[0],defenders=_ref331.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref339){var attacker=_ref339[0],defenders=_ref339.slice(1);
...
darkvoid:{
anim:function(scene,_ref358){var attacker=_ref358[0],defenders=_ref358.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref371){var attacker=_ref371[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
coreenforcer:{
anim:function(scene,_ref410){var attacker=_ref410[0],defenders=_ref410.slice(1);
...
shadowdance:{
anim:function(scene,_ref423){var attacker=_ref423[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowdetonation:{
anim:function(scene,_ref426){var attacker=_ref426[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowfireball3',{
x:attacker.x+40,
y:attacker.y,
...
shadowrave:{
anim:function(scene,_ref459){var attacker=_ref459[0],defenders=_ref459.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref489){var attacker=_ref489[0],defenders=_ref489.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref492){var attacker=_ref492[0],defenders=_ref492.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref524){var attacker=_ref524[0],defenders=_ref524.slice(1);
attacker.anim({x:attacker.x-10,time:300});
