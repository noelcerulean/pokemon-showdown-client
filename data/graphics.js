...
shelltrap:{
anim:function(scene,_ref173){var attacker=_ref173[0],defenders=_ref173.slice(1);for(var _i3=0;_i3<
...
poweroutage:{
anim:function(scene,_ref214){var attacker=_ref214[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref215){var attacker=_ref215[0],defenders=_ref215.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref216){var attacker=_ref216[0],defenders=_ref216.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref217){var attacker=_ref217[0],defenders=_ref217.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref242){var attacker=_ref242[0],defenders=_ref242.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref250){var attacker=_ref250[0],defenders=_ref250.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref263){var attacker=_ref263[0],defenders=_ref263.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref265){var attacker=_ref265[0],defenders=_ref265.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref266){var attacker=_ref266[0],defenders=_ref266.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref276){var attacker=_ref276[0],defenders=_ref276.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref287){var attacker=_ref287[0];
...
residualAnim:function(scene,_ref288){var attacker=_ref288[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref313){var attacker=_ref313[0],defenders=_ref313.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref315){var attacker=_ref315[0],defenders=_ref315.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref317){var attacker=_ref317[0],defenders=_ref317.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref318){var attacker=_ref318[0],defenders=_ref318.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_ref319.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref320){var attacker=_ref320[0],defenders=_ref320.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref321){var attacker=_ref321[0],defenders=_ref321.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref322){var attacker=_ref322[0],defenders=_ref322.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref329){var attacker=_ref329[0],defenders=_ref329.slice(1);
...
darkvoid:{
anim:function(scene,_ref348){var attacker=_ref348[0],defenders=_ref348.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref361){var attacker=_ref361[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref366){var attacker=_ref366[0],defenders=_ref366.slice(1);
...
shadowdance:{
anim:function(scene,_ref405){var attacker=_ref405[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref429){var attacker=_ref429[0],defenders=_ref429.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref450){var attacker=_ref450[0],defenders=_ref450.slice(1);for(var _i32=0;_i32<
...
unifiedupsurge:{
anim:function(scene,_ref484){var attacker=_ref484[0],defenders=_ref484.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
