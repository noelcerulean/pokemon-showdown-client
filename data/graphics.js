...
shelltrap:{
anim:function(scene,_ref178){var attacker=_ref178[0],defenders=_ref178.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref195){var attacker=_ref195[0],defenders=_ref195.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
poweroutage:{
anim:function(scene,_ref219){var attacker=_ref219[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref220){var attacker=_ref220[0],defenders=_ref220.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref221){var attacker=_ref221[0],defenders=_ref221.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref222){var attacker=_ref222[0],defenders=_ref222.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref247){var attacker=_ref247[0],defenders=_ref247.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref255){var attacker=_ref255[0],defenders=_ref255.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref268){var attacker=_ref268[0],defenders=_ref268.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_ref270.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref271){var attacker=_ref271[0],defenders=_ref271.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref281){var attacker=_ref281[0],defenders=_ref281.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref292){var attacker=_ref292[0];
...
residualAnim:function(scene,_ref293){var attacker=_ref293[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref318){var attacker=_ref318[0],defenders=_ref318.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref320){var attacker=_ref320[0],defenders=_ref320.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref322){var attacker=_ref322[0],defenders=_ref322.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref325){var attacker=_ref325[0],defenders=_ref325.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_ref326.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref327){var attacker=_ref327[0],defenders=_ref327.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref334){var attacker=_ref334[0],defenders=_ref334.slice(1);
...
mistyexplosion:{
anim:function(scene,_ref366){var attacker=_ref366[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref371){var attacker=_ref371[0],defenders=_ref371.slice(1);
...
shadowdance:{
anim:function(scene,_ref410){var attacker=_ref410[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowhubris:{
anim:function(scene,_ref425){var attacker=_ref425[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowmoon:{
anim:function(scene,_ref428){var attacker=_ref428[0];
...
shadowrave:{
anim:function(scene,_ref434){var attacker=_ref434[0],defenders=_ref434.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref455){var attacker=_ref455[0],defenders=_ref455.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref457){var attacker=_ref457[0],defenders=_ref457.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref488){var attacker=_ref488[0],defenders=_ref488.slice(1);
attacker.anim({x:attacker.x-10,time:300});
