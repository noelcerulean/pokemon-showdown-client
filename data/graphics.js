...
shelltrap:{
anim:function(scene,_ref175){var attacker=_ref175[0],defenders=_ref175.slice(1);for(var _i3=0;_i3<
...
hypervoice:{
anim:function(scene,_ref215){var attacker=_ref215[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref217){var attacker=_ref217[0],defenders=_ref217.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref218){var attacker=_ref218[0],defenders=_ref218.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref219){var attacker=_ref219[0],defenders=_ref219.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref244){var attacker=_ref244[0],defenders=_ref244.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref252){var attacker=_ref252[0],defenders=_ref252.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref265){var attacker=_ref265[0],defenders=_ref265.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref267){var attacker=_ref267[0],defenders=_ref267.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref268){var attacker=_ref268[0],defenders=_ref268.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref278){var attacker=_ref278[0],defenders=_ref278.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref289){var attacker=_ref289[0];
...
residualAnim:function(scene,_ref290){var attacker=_ref290[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref315){var attacker=_ref315[0],defenders=_ref315.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref317){var attacker=_ref317[0],defenders=_ref317.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_ref319.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref320){var attacker=_ref320[0],defenders=_ref320.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref321){var attacker=_ref321[0],defenders=_ref321.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref322){var attacker=_ref322[0],defenders=_ref322.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref331){var attacker=_ref331[0],defenders=_ref331.slice(1);
...
darkvoid:{
anim:function(scene,_ref350){var attacker=_ref350[0],defenders=_ref350.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref363){var attacker=_ref363[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref368){var attacker=_ref368[0],defenders=_ref368.slice(1);
...
brutalswing:{
anim:function(scene,_ref386){var attacker=_ref386[0],defenders=_ref386.slice(1);
...
shadowdance:{
anim:function(scene,_ref407){var attacker=_ref407[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowhubris:{
anim:function(scene,_ref422){var attacker=_ref422[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowrave:{
anim:function(scene,_ref431){var attacker=_ref431[0],defenders=_ref431.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref452){var attacker=_ref452[0],defenders=_ref452.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref454){var attacker=_ref454[0],defenders=_ref454.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref485){var attacker=_ref485[0],defenders=_ref485.slice(1);
attacker.anim({x:attacker.x-10,time:300});
