...
rockslide:{
anim:function(scene,_ref253){var attacker=_ref253[0],defenders=_ref253.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref255){var attacker=_ref255[0],defenders=_ref255.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref256){var attacker=_ref256[0],defenders=_ref256.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref266){var attacker=_ref266[0],defenders=_ref266.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref276){var attacker=_ref276[0];
...
residualAnim:function(scene,_ref277){var attacker=_ref277[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref302){var attacker=_ref302[0],defenders=_ref302.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref304){var attacker=_ref304[0],defenders=_ref304.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref306){var attacker=_ref306[0],defenders=_ref306.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref307){var attacker=_ref307[0],defenders=_ref307.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref308){var attacker=_ref308[0],defenders=_ref308.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref309){var attacker=_ref309[0],defenders=_ref309.slice(1);for(var _i20=0;_i20<
...
glaciallance:{
anim:function(scene,_ref316){var attacker=_ref316[0],defenders=_ref316.slice(1);
...
mistyexplosion:{
anim:function(scene,_ref347){var attacker=_ref347[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
shadowdance:{
anim:function(scene,_ref391){var attacker=_ref391[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref414){var attacker=_ref414[0],defenders=_ref414.slice(1);for(var _i29=0;_i29<
...
shadowwave:{
anim:function(scene,_ref435){var attacker=_ref435[0],defenders=_ref435.slice(1);for(var _i30=0;_i30<
...
clangoroussoulblaze:{
anim:function(scene,_ref467){var attacker=_ref467[0],defenders=_ref467.slice(1);
attacker.anim({x:attacker.x-10,time:300});
