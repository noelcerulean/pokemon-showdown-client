...
shelltrap:{
anim:function(scene,_ref169){var attacker=_ref169[0],defenders=_ref169.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref185){var attacker=_ref185[0],defenders=_ref185.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
hypervoice:{
anim:function(scene,_ref206){var attacker=_ref206[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref208){var attacker=_ref208[0],defenders=_ref208.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref209){var attacker=_ref209[0],defenders=_ref209.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref210){var attacker=_ref210[0],defenders=_ref210.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref235){var attacker=_ref235[0],defenders=_ref235.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref243){var attacker=_ref243[0],defenders=_ref243.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref256){var attacker=_ref256[0],defenders=_ref256.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref258){var attacker=_ref258[0],defenders=_ref258.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref259){var attacker=_ref259[0],defenders=_ref259.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref279){var attacker=_ref279[0];
...
residualAnim:function(scene,_ref280){var attacker=_ref280[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref305){var attacker=_ref305[0],defenders=_ref305.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref307){var attacker=_ref307[0],defenders=_ref307.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref309){var attacker=_ref309[0],defenders=_ref309.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref310){var attacker=_ref310[0],defenders=_ref310.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref311){var attacker=_ref311[0],defenders=_ref311.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref312){var attacker=_ref312[0],defenders=_ref312.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref313){var attacker=_ref313[0],defenders=_ref313.slice(1);for(var _i21=0;_i21<
...
glaciallance:{
anim:function(scene,_ref320){var attacker=_ref320[0],defenders=_ref320.slice(1);
...
darkvoid:{
anim:function(scene,_ref339){var attacker=_ref339[0],defenders=_ref339.slice(1);for(var _i23=0;_i23<
...
mistyexplosion:{
anim:function(scene,_ref352){var attacker=_ref352[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref357){var attacker=_ref357[0],defenders=_ref357.slice(1);
...
shadowrave:{
anim:function(scene,_ref419){var attacker=_ref419[0],defenders=_ref419.slice(1);for(var _i30=0;_i30<
...
shadowwave:{
anim:function(scene,_ref440){var attacker=_ref440[0],defenders=_ref440.slice(1);for(var _i31=0;_i31<
...
shadowwreckage:{
anim:function(scene,_ref442){var attacker=_ref442[0],defenders=_ref442.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref473){var attacker=_ref473[0],defenders=_ref473.slice(1);
attacker.anim({x:attacker.x-10,time:300});
...
unifiedupsurge:{
anim:function(scene,_ref474){var attacker=_ref474[0],defenders=_ref474.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
