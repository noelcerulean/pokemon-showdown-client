...
shelltrap:{
anim:function(scene,_ref171){var attacker=_ref171[0],defenders=_ref171.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref187){var attacker=_ref187[0],defenders=_ref187.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
bulldoze:{
anim:function(scene,_ref188){var attacker=_ref188[0],defenders=_ref188.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0},
...
hypervoice:{
anim:function(scene,_ref210){var attacker=_ref210[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
poweroutage:{
anim:function(scene,_ref211){var attacker=_ref211[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref212){var attacker=_ref212[0],defenders=_ref212.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref213){var attacker=_ref213[0],defenders=_ref213.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref214){var attacker=_ref214[0],defenders=_ref214.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref239){var attacker=_ref239[0],defenders=_ref239.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref247){var attacker=_ref247[0],defenders=_ref247.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref260){var attacker=_ref260[0],defenders=_ref260.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref262){var attacker=_ref262[0],defenders=_ref262.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref263){var attacker=_ref263[0],defenders=_ref263.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref273){var attacker=_ref273[0],defenders=_ref273.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref284){var attacker=_ref284[0];
...
residualAnim:function(scene,_ref285){var attacker=_ref285[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref310){var attacker=_ref310[0],defenders=_ref310.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref312){var attacker=_ref312[0],defenders=_ref312.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref314){var attacker=_ref314[0],defenders=_ref314.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref315){var attacker=_ref315[0],defenders=_ref315.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref316){var attacker=_ref316[0],defenders=_ref316.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref317){var attacker=_ref317[0],defenders=_ref317.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref318){var attacker=_ref318[0],defenders=_ref318.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_ref319.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_ref326.slice(1);
...
darkvoid:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref358){var attacker=_ref358[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref363){var attacker=_ref363[0],defenders=_ref363.slice(1);
...
shadowdance:{
anim:function(scene,_ref402){var attacker=_ref402[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowhubris:{
anim:function(scene,_ref417){var attacker=_ref417[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowrave:{
anim:function(scene,_ref426){var attacker=_ref426[0],defenders=_ref426.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref447){var attacker=_ref447[0],defenders=_ref447.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref449){var attacker=_ref449[0],defenders=_ref449.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref480){var attacker=_ref480[0],defenders=_ref480.slice(1);
attacker.anim({x:attacker.x-10,time:300});
...
unifiedupsurge:{
anim:function(scene,_ref481){var attacker=_ref481[0],defenders=_ref481.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
