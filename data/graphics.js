...
lifedew:{
anim:function(scene,_ref22){var attacker=_ref22[0],defenders=_ref22.slice(1);for(var _i=0;_i<
...
junglehealing:{
anim:function(scene,_ref23){var attacker=_ref23[0],defenders=_ref23.slice(1);
...
roost:{
anim:function(scene,_ref60){var attacker=_ref60[0],defender=_ref60[1];
scene.showEffect('feather',{
x:defender.x+50,
y:defender.y,
z:defender.z,
...
prepareAnim:function(scene,_ref87){var attacker=_ref87[0],defender=_ref87[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300},
...
shelltrap:{
anim:function(scene,_ref181){var attacker=_ref181[0],defenders=_ref181.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref198){var attacker=_ref198[0],defenders=_ref198.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
bulldoze:{
anim:function(scene,_ref199){var attacker=_ref199[0],defenders=_ref199.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0},
...
hypervoice:{
anim:function(scene,_ref222){var attacker=_ref222[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
poweroutage:{
anim:function(scene,_ref223){var attacker=_ref223[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref224){var attacker=_ref224[0],defenders=_ref224.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref225){var attacker=_ref225[0],defenders=_ref225.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref226){var attacker=_ref226[0],defenders=_ref226.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref251){var attacker=_ref251[0],defenders=_ref251.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref259){var attacker=_ref259[0],defenders=_ref259.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref272){var attacker=_ref272[0],defenders=_ref272.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref274){var attacker=_ref274[0],defenders=_ref274.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref275){var attacker=_ref275[0],defenders=_ref275.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref286){var attacker=_ref286[0],defenders=_ref286.slice(1);for(var _i14=0;_i14<
...
surf:{
anim:function(scene,_ref323){var attacker=_ref323[0],defenders=_ref323.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref325){var attacker=_ref325[0],defenders=_ref325.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_ref328.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref329){var attacker=_ref329[0],defenders=_ref329.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref330){var attacker=_ref330[0],defenders=_ref330.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref331){var attacker=_ref331[0],defenders=_ref331.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref333){var attacker=_ref333[0],defenders=_ref333.slice(1);for(var _i22=0;_i22<
...
darkvoid:{
anim:function(scene,_ref359){var attacker=_ref359[0],defenders=_ref359.slice(1);for(var _i24=0;_i24<
...
shadowdance:{
anim:function(scene,_ref427){var attacker=_ref427[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref463){var attacker=_ref463[0],defenders=_ref463.slice(1);for(var _i32=0;_i32<
...
shadowwave:{
anim:function(scene,_ref493){var attacker=_ref493[0],defenders=_ref493.slice(1);for(var _i33=0;_i33<
...
shadowwreckage:{
anim:function(scene,_ref496){var attacker=_ref496[0],defenders=_ref496.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref528){var attacker=_ref528[0],defenders=_ref528.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
...
unifiedupsurge:{
anim:function(scene,_ref529){var attacker=_ref529[0],defenders=_ref529.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
