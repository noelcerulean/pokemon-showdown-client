...
earthquake:{
anim:function(scene,_ref184){var attacker=_ref184[0],defenders=_ref184.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
hypervoice:{
anim:function(scene,_ref205){var attacker=_ref205[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref207){var attacker=_ref207[0],defenders=_ref207.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref208){var attacker=_ref208[0],defenders=_ref208.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref209){var attacker=_ref209[0],defenders=_ref209.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref233){var attacker=_ref233[0],defenders=_ref233.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref241){var attacker=_ref241[0],defenders=_ref241.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref254){var attacker=_ref254[0],defenders=_ref254.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref256){var attacker=_ref256[0],defenders=_ref256.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref257){var attacker=_ref257[0],defenders=_ref257.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref267){var attacker=_ref267[0],defenders=_ref267.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref277){var attacker=_ref277[0];
...
residualAnim:function(scene,_ref278){var attacker=_ref278[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref303){var attacker=_ref303[0],defenders=_ref303.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref305){var attacker=_ref305[0],defenders=_ref305.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref307){var attacker=_ref307[0],defenders=_ref307.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref308){var attacker=_ref308[0],defenders=_ref308.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref309){var attacker=_ref309[0],defenders=_ref309.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref310){var attacker=_ref310[0],defenders=_ref310.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref311){var attacker=_ref311[0],defenders=_ref311.slice(1);for(var _i21=0;_i21<
...
glaciallance:{
anim:function(scene,_ref318){var attacker=_ref318[0],defenders=_ref318.slice(1);
...
darkvoid:{
anim:function(scene,_ref337){var attacker=_ref337[0],defenders=_ref337.slice(1);for(var _i23=0;_i23<
...
mistyexplosion:{
anim:function(scene,_ref350){var attacker=_ref350[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref355){var attacker=_ref355[0],defenders=_ref355.slice(1);
...
shadowrave:{
anim:function(scene,_ref417){var attacker=_ref417[0],defenders=_ref417.slice(1);for(var _i30=0;_i30<
...
shadowwave:{
anim:function(scene,_ref438){var attacker=_ref438[0],defenders=_ref438.slice(1);for(var _i31=0;_i31<
...
shadowwreckage:{
anim:function(scene,_ref440){var attacker=_ref440[0],defenders=_ref440.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref471){var attacker=_ref471[0],defenders=_ref471.slice(1);
attacker.anim({x:attacker.x-10,time:300});
