...
hypervoice:{
anim:function(scene,_ref225){var attacker=_ref225[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref227){var attacker=_ref227[0],defenders=_ref227.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref228){var attacker=_ref228[0],defenders=_ref228.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref229){var attacker=_ref229[0],defenders=_ref229.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref254){var attacker=_ref254[0],defenders=_ref254.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref262){var attacker=_ref262[0],defenders=_ref262.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref275){var attacker=_ref275[0],defenders=_ref275.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref277){var attacker=_ref277[0],defenders=_ref277.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref278){var attacker=_ref278[0],defenders=_ref278.slice(1);for(var _i13=0;_i13<
...
wish:{
anim:function(scene,_ref300){var attacker=_ref300[0];
...
residualAnim:function(scene,_ref301){var attacker=_ref301[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref327){var attacker=_ref327[0],defenders=_ref327.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref329){var attacker=_ref329[0],defenders=_ref329.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref333){var attacker=_ref333[0],defenders=_ref333.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref334){var attacker=_ref334[0],defenders=_ref334.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref335){var attacker=_ref335[0],defenders=_ref335.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref337){var attacker=_ref337[0],defenders=_ref337.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref344){var attacker=_ref344[0],defenders=_ref344.slice(1);
...
darkvoid:{
anim:function(scene,_ref363){var attacker=_ref363[0],defenders=_ref363.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref376){var attacker=_ref376[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref381){var attacker=_ref381[0],defenders=_ref381.slice(1);
...
brutalswing:{
anim:function(scene,_ref399){var attacker=_ref399[0],defenders=_ref399.slice(1);
...
shadowdance:{
anim:function(scene,_ref432){var attacker=_ref432[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref468){var attacker=_ref468[0],defenders=_ref468.slice(1);for(var _i32=0;_i32<
...
shadowwave:{
anim:function(scene,_ref498){var attacker=_ref498[0],defenders=_ref498.slice(1);for(var _i33=0;_i33<
...
shadowwreckage:{
anim:function(scene,_ref501){var attacker=_ref501[0],defenders=_ref501.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref534){var attacker=_ref534[0],defenders=_ref534.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
