...
icywind:{
anim:function(scene,_ref234){var attacker=_ref234[0],defenders=_ref234.slice(1);for(var _i9=0;_i9<
...
rockslide:{
anim:function(scene,_ref255){var attacker=_ref255[0],defenders=_ref255.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref257){var attacker=_ref257[0],defenders=_ref257.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref258){var attacker=_ref258[0],defenders=_ref258.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref268){var attacker=_ref268[0],defenders=_ref268.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref278){var attacker=_ref278[0];
...
residualAnim:function(scene,_ref279){var attacker=_ref279[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref304){var attacker=_ref304[0],defenders=_ref304.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref306){var attacker=_ref306[0],defenders=_ref306.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref308){var attacker=_ref308[0],defenders=_ref308.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref309){var attacker=_ref309[0],defenders=_ref309.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref310){var attacker=_ref310[0],defenders=_ref310.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref311){var attacker=_ref311[0],defenders=_ref311.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref312){var attacker=_ref312[0],defenders=_ref312.slice(1);for(var _i21=0;_i21<
...
glaciallance:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_ref319.slice(1);
...
darkvoid:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i23=0;_i23<
...
mistyexplosion:{
anim:function(scene,_ref351){var attacker=_ref351[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
brutalswing:{
anim:function(scene,_ref374){var attacker=_ref374[0],defenders=_ref374.slice(1);
...
shadowdance:{
anim:function(scene,_ref395){var attacker=_ref395[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref418){var attacker=_ref418[0],defenders=_ref418.slice(1);for(var _i30=0;_i30<
...
shadowwave:{
anim:function(scene,_ref439){var attacker=_ref439[0],defenders=_ref439.slice(1);for(var _i31=0;_i31<
...
shadowwreckage:{
anim:function(scene,_ref441){var attacker=_ref441[0],defenders=_ref441.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref472){var attacker=_ref472[0],defenders=_ref472.slice(1);
attacker.anim({x:attacker.x-10,time:300});
