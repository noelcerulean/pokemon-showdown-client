...
boomburst:{
anim:function(scene,_ref210){var attacker=_ref210[0],defenders=_ref210.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref211){var attacker=_ref211[0],defenders=_ref211.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref212){var attacker=_ref212[0],defenders=_ref212.slice(1);for(var _i8=0;_i8<
...
sludgewave:{
anim:function(scene,_ref245){var attacker=_ref245[0],defenders=_ref245.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref258){var attacker=_ref258[0],defenders=_ref258.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref260){var attacker=_ref260[0],defenders=_ref260.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref261){var attacker=_ref261[0],defenders=_ref261.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref271){var attacker=_ref271[0],defenders=_ref271.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref282){var attacker=_ref282[0];
...
residualAnim:function(scene,_ref283){var attacker=_ref283[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref308){var attacker=_ref308[0],defenders=_ref308.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref310){var attacker=_ref310[0],defenders=_ref310.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref312){var attacker=_ref312[0],defenders=_ref312.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref313){var attacker=_ref313[0],defenders=_ref313.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref314){var attacker=_ref314[0],defenders=_ref314.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref315){var attacker=_ref315[0],defenders=_ref315.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref316){var attacker=_ref316[0],defenders=_ref316.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref317){var attacker=_ref317[0],defenders=_ref317.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);
...
darkvoid:{
anim:function(scene,_ref343){var attacker=_ref343[0],defenders=_ref343.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref356){var attacker=_ref356[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref361){var attacker=_ref361[0],defenders=_ref361.slice(1);
...
shadowdance:{
anim:function(scene,_ref400){var attacker=_ref400[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref424){var attacker=_ref424[0],defenders=_ref424.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref445){var attacker=_ref445[0],defenders=_ref445.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref447){var attacker=_ref447[0],defenders=_ref447.slice(1);
