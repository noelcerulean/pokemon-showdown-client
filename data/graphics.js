...
shelltrap:{
anim:function(scene,_ref179){var attacker=_ref179[0],defenders=_ref179.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref196){var attacker=_ref196[0],defenders=_ref196.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
bulldoze:{
anim:function(scene,_ref197){var attacker=_ref197[0],defenders=_ref197.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0},
...
hypervoice:{
anim:function(scene,_ref220){var attacker=_ref220[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
poweroutage:{
anim:function(scene,_ref221){var attacker=_ref221[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref222){var attacker=_ref222[0],defenders=_ref222.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref223){var attacker=_ref223[0],defenders=_ref223.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref224){var attacker=_ref224[0],defenders=_ref224.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref249){var attacker=_ref249[0],defenders=_ref249.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref257){var attacker=_ref257[0],defenders=_ref257.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_ref270.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref272){var attacker=_ref272[0],defenders=_ref272.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref273){var attacker=_ref273[0],defenders=_ref273.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref283){var attacker=_ref283[0],defenders=_ref283.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref294){var attacker=_ref294[0];
...
residualAnim:function(scene,_ref295){var attacker=_ref295[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref320){var attacker=_ref320[0],defenders=_ref320.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref322){var attacker=_ref322[0],defenders=_ref322.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref324){var attacker=_ref324[0],defenders=_ref324.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref325){var attacker=_ref325[0],defenders=_ref325.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_ref326.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref327){var attacker=_ref327[0],defenders=_ref327.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_ref328.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref329){var attacker=_ref329[0],defenders=_ref329.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);
...
darkvoid:{
anim:function(scene,_ref355){var attacker=_ref355[0],defenders=_ref355.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref368){var attacker=_ref368[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref373){var attacker=_ref373[0],defenders=_ref373.slice(1);
...
brutalswing:{
anim:function(scene,_ref391){var attacker=_ref391[0],defenders=_ref391.slice(1);
...
shadowdance:{
anim:function(scene,_ref420){var attacker=_ref420[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowrave:{
anim:function(scene,_ref456){var attacker=_ref456[0],defenders=_ref456.slice(1);for(var _i31=0;_i31<
...
shadowwave:{
anim:function(scene,_ref486){var attacker=_ref486[0],defenders=_ref486.slice(1);for(var _i32=0;_i32<
...
shadowwreckage:{
anim:function(scene,_ref489){var attacker=_ref489[0],defenders=_ref489.slice(1);
...
unifiedupsurge:{
anim:function(scene,_ref522){var attacker=_ref522[0],defenders=_ref522.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
...
antiquearabesque:{
anim:function(scene,_ref523){var attacker=_ref523[0],defenders=_ref523.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
