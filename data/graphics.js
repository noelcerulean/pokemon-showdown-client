...
shelltrap:{
anim:function(scene,_ref183){var attacker=_ref183[0],defenders=_ref183.slice(1);for(var _i3=0;_i3<
...
hypervoice:{
anim:function(scene,_ref226){var attacker=_ref226[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref228){var attacker=_ref228[0],defenders=_ref228.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref229){var attacker=_ref229[0],defenders=_ref229.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref230){var attacker=_ref230[0],defenders=_ref230.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref255){var attacker=_ref255[0],defenders=_ref255.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref263){var attacker=_ref263[0],defenders=_ref263.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref276){var attacker=_ref276[0],defenders=_ref276.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref278){var attacker=_ref278[0],defenders=_ref278.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref279){var attacker=_ref279[0],defenders=_ref279.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref290){var attacker=_ref290[0],defenders=_ref290.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref301){var attacker=_ref301[0];
...
residualAnim:function(scene,_ref302){var attacker=_ref302[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_ref328.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref330){var attacker=_ref330[0],defenders=_ref330.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref333){var attacker=_ref333[0],defenders=_ref333.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref334){var attacker=_ref334[0],defenders=_ref334.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref335){var attacker=_ref335[0],defenders=_ref335.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref337){var attacker=_ref337[0],defenders=_ref337.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i22=0;_i22<
...
glaciallance:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);
...
darkvoid:{
anim:function(scene,_ref364){var attacker=_ref364[0],defenders=_ref364.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref377){var attacker=_ref377[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref382){var attacker=_ref382[0],defenders=_ref382.slice(1);
...
astralbarrage:{
anim:function(scene,_ref414){var attacker=_ref414[0],defenders=_ref414.slice(1);
scene.backgroundEffect('#000000',600,0.6);
scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)',1100,0.6,600);
...
coreenforcer:{
anim:function(scene,_ref420){var attacker=_ref420[0],defenders=_ref420.slice(1);
...
shadowdance:{
anim:function(scene,_ref433){var attacker=_ref433[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowhubris:{
anim:function(scene,_ref456){var attacker=_ref456[0];
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowshadowball',{
x:attacker.x,
y:attacker.y,
...
shadowmoon:{
anim:function(scene,_ref462){var attacker=_ref462[0];
...
shadowrave:{
anim:function(scene,_ref469){var attacker=_ref469[0],defenders=_ref469.slice(1);for(var _i32=0;_i32<
...
shadowvelocity:{
anim:function(scene,_ref496){var attacker=_ref496[0];
scene.backgroundEffect('#110131',1100,0.7);
attacker.anim({x:attacker.x-10,time:200});
attacker.anim({x:attacker.x+10,time:300});
attacker.anim({x:attacker.x-20,time:150});
...
shadowwave:{
anim:function(scene,_ref499){var attacker=_ref499[0],defenders=_ref499.slice(1);for(var _i33=0;_i33<
...
shadowwreckage:{
anim:function(scene,_ref502){var attacker=_ref502[0],defenders=_ref502.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref535){var attacker=_ref535[0],defenders=_ref535.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
