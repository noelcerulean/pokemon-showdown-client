...
prepareAnim:function(scene,_ref88){var attacker=_ref88[0],defender=_ref88[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300},
...
shelltrap:{
anim:function(scene,_ref182){var attacker=_ref182[0],defenders=_ref182.slice(1);for(var _i3=0;_i3<
...
earthquake:{
anim:function(scene,_ref200){var attacker=_ref200[0],defenders=_ref200.slice(1);
scene.$bg.animate({
top:-90,
bottom:0},
75).animate({
...
hypervoice:{
anim:function(scene,_ref224){var attacker=_ref224[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref226){var attacker=_ref226[0],defenders=_ref226.slice(1);for(var _i6=0;_i6<
...
boisterousblackout:{
anim:function(scene,_ref227){var attacker=_ref227[0],defenders=_ref227.slice(1);for(var _i7=0;_i7<
...
heatwave:{
anim:function(scene,_ref228){var attacker=_ref228[0],defenders=_ref228.slice(1);for(var _i8=0;_i8<
...
icywind:{
anim:function(scene,_ref253){var attacker=_ref253[0],defenders=_ref253.slice(1);for(var _i9=0;_i9<
...
sludgewave:{
anim:function(scene,_ref261){var attacker=_ref261[0],defenders=_ref261.slice(1);for(var _i10=0;_i10<
...
rockslide:{
anim:function(scene,_ref274){var attacker=_ref274[0],defenders=_ref274.slice(1);for(var _i11=0;_i11<
...
thousandarrows:{
anim:function(scene,_ref276){var attacker=_ref276[0],defenders=_ref276.slice(1);for(var _i12=0;_i12<
...
thousandwaves:{
anim:function(scene,_ref277){var attacker=_ref277[0],defenders=_ref277.slice(1);for(var _i13=0;_i13<
...
fierywrath:{
anim:function(scene,_ref288){var attacker=_ref288[0],defenders=_ref288.slice(1);for(var _i14=0;_i14<
...
wish:{
anim:function(scene,_ref299){var attacker=_ref299[0];
...
residualAnim:function(scene,_ref300){var attacker=_ref300[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_ref326.slice(1);for(var _i15=0;_i15<
...
muddywater:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_ref328.slice(1);for(var _i16=0;_i16<
...
lavaplume:{
anim:function(scene,_ref331){var attacker=_ref331[0],defenders=_ref331.slice(1);for(var _i17=0;_i17<
...
dragonenergy:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);for(var _i18=0;_i18<
...
eruption:{
anim:function(scene,_ref333){var attacker=_ref333[0],defenders=_ref333.slice(1);for(var _i19=0;_i19<
...
waterspout:{
anim:function(scene,_ref334){var attacker=_ref334[0],defenders=_ref334.slice(1);for(var _i20=0;_i20<
...
fallout:{
anim:function(scene,_ref335){var attacker=_ref335[0],defenders=_ref335.slice(1);for(var _i21=0;_i21<
...
icefall:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);for(var _i22=0;_i22<
...
darkvoid:{
anim:function(scene,_ref362){var attacker=_ref362[0],defenders=_ref362.slice(1);for(var _i24=0;_i24<
...
mistyexplosion:{
anim:function(scene,_ref375){var attacker=_ref375[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
...
petalblizzard:{
anim:function(scene,_ref380){var attacker=_ref380[0],defenders=_ref380.slice(1);
...
shadowdance:{
anim:function(scene,_ref431){var attacker=_ref431[0];
BattleOtherAnims.shake.anim(scene,[attacker]);
scene.backgroundEffect('#110131',700,0.7);
scene.showEffect('shadowwisp',{
x:attacker.x,
...
shadowmoon:{
anim:function(scene,_ref460){var attacker=_ref460[0];
...
shadowrave:{
anim:function(scene,_ref467){var attacker=_ref467[0],defenders=_ref467.slice(1);for(var _i32=0;_i32<
...
shadowvelocity:{
anim:function(scene,_ref494){var attacker=_ref494[0];
scene.backgroundEffect('#110131',1100,0.7);
attacker.anim({x:attacker.x-10,time:200});
attacker.anim({x:attacker.x+10,time:300});
attacker.anim({x:attacker.x-20,time:150});
...
shadowwave:{
anim:function(scene,_ref497){var attacker=_ref497[0],defenders=_ref497.slice(1);for(var _i33=0;_i33<
...
shadowwreckage:{
anim:function(scene,_ref500){var attacker=_ref500[0],defenders=_ref500.slice(1);
...
clangoroussoulblaze:{
anim:function(scene,_ref533){var attacker=_ref533[0],defenders=_ref533.slice(1);
attacker.anim({x:attacker.x-10,time:300});
attacker.anim({x:attacker.x+10,time:400});
attacker.anim({x:attacker.x,time:300});
attacker.delay(50);
