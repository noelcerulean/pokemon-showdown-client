...
class PokemonSprite extends Sprite {
	...
	animSummon(pokemon: Pokemon, slot: number, instant?: boolean) {
		...
		//Shadow Aura animation and Omniverum Light
	...
	getStatbarHTML(pokemon: Pokemon) {
		...
		else if (pokemon.speciesForme === 'Unfezant-Primal') symbol = 'emerald';
		else if (pokemon.speciesForme === 'Unfezant-F-Primal') symbol = 'emerald';
