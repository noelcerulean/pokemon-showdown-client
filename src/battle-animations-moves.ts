...
const BattleMoveAnims: AnimTable = {
	...
	berserkterrain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#FF0303', 1000, 0.3);
			BattleOtherAnims.dance.anim(scene, [attacker]);
		},
	},
	grassyterrain: {
	...
	gulchkick: {
		anim(scene, [attacker, defender]) {
			BattleOtherAnims.kick.anim(scene, [attacker, defender]);
			scene.backgroundEffect('#91664C', 300, 0.3, 500);
	...
	combardment: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#326513', 600, 0.3, 400);
			scene.showEffect('fist1', {
				x: defender.x,
				y: defender.y + 80,
				z: defender.behind(-15),
	...
	savagehorn: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#390000 30%, #B84038)', 400, 0.3);
			scene.showEffect('wisp', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	ruinousriptide: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#003B82 30%, #4D98E3)', 900, 0.5);
			scene.showEffect('angry', {
				x: attacker.x - 10,
				y: attacker.y + 50,
				z: attacker.z,
	...
	ravagement: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#390000 30%,rgb(110, 7, 0))', 600, 0.6, 400);
			scene.showEffect('angry', {
				x: attacker.x - 10,
				y: attacker.y + 50,
				z: attacker.z,
	...
	icedrill: { // todo: rip horn sprite and redo animation
		anim(scene, [attacker, defender]) {
			attacker.anim({
				x: defender.x,
				y: defender.y,
	...
	fallout: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('#8800DD', 1100, 0.2);
			scene.showEffect('colorball7', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	icefall: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('linear-gradient(#5CBFBF 30%, #9DF0F5)', 1100, 0.4);
			scene.showEffect('iceball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	sandinversion: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#C2B280', 700, 0.5);
			scene.showEffect('iceball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	passionstorm: { 
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#6a2896', 700, 0.3);
			scene.showEffect('energyball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	pheromonicphantasmagoria: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-allurediffusion.png')`, 1100, 0.4, 600);
	...
	taogenesis: {
		anim(scene, [attacker, ...defenders]) {
			...
			const defender = defenders[1] || defenders[0];
			scene.backgroundEffect('rgb(28, 73, 11)', 300, 0.9);
			scene.backgroundEffect(`url('https://${Config.routes.client}/sprites/gen6bgs/bg-champion.png')`, 2000, 0.7, 300);
			scene.backgroundEffect('linear-gradient(rgb(121, 235, 93) 20%,rgb(34, 85, 11)', 2000, 0.6, 300);
			scene.backgroundEffect('rgb(203, 255, 155)', 1000, 0.9, 2200);
			scene.showEffect('shine', {
				x: attacker.x - 10,
				y: attacker.y - 10,
				z: attacker.z,
	...
	// shadow move animations
	shadowambush: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 900, 0.7);
	...
	shadowwall: {
		anim: BattleOtherAnims.shadowselfstatus.anim,
	},
	shadowbeam: {
		anim(scene, [attacker, defender]) {
			let xstep = (defender.x - attacker.x) / 5;
			...
			scene.backgroundEffect('#110131', 900, 0.7);
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-shadowsky.png')`, 900, 0.8);
		...
		prepareAnim: BattleOtherAnims.shadowchargestatus.anim,
	},
	shadowblast: {
		anim(scene, [attacker, defender]) {
			let xstep = (defender.x - attacker.x) / 5;
			...
			scene.backgroundEffect('#110131', 1800, 0.7);
			...
			scene.showEffect('shadowfireball3', {
				x: defender.x,
				y: defender.y,
				z: defender.behind(5),
				scale: 0,
	...
	shadowbluff: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 700, 0.7);
			scene.showEffect('shadowrightchop', {
				x: defender.x + 15,
				y: defender.y,
				z: defender.behind(-120),
				scale: 0.3,
			...
			scene.showEffect('shadowleftchop', {
				x: defender.x - 15,
				y: defender.y,
				z: defender.behind(-120),
				scale: 0.3,
	...
	shadowchant: {
		anim: BattleOtherAnims.shadowlightstatus.anim,
	},
	shadowcharge: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 700, 0.7);
	...
	shadowchew: {
		anim(scene, [attacker, defender]) {
			BattleOtherAnims.shadowbite.anim(scene, [attacker, defender]);
			BattleOtherAnims.contactattack.anim(scene, [attacker, defender]);
		},
	},
	shadowchop: {
	...
	shadowdestruction: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 700, 0.7);
			scene.showEffect('shadowimpact2', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
				scale: 0,
	...
	shadowdetonation: {
		anim(scene, [attacker]) {
			...
			scene.showEffect('shadowfireball', {
				x: attacker.x - 40,
				y: attacker.y - 20,
				z: attacker.z,
				scale: 0,
	...
	shadowfirestorm: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 900, 0.7);
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-sunnyday.jpg')`, 900, 0.3);
	...
	shadowfog: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect('#110131', 1000, 0.7);
			for (let i = 0; i < 4; i++) {
				scene.showEffect('shadowwisp', {
					x: attacker.x,
					y: attacker.y,
	...
	shadowfountain: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#110131', 500, 0.7);
			scene.showEffect('shadowshadowball', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	shadowgale: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 900, 0.7);
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-shadowsky.png')`, 900, 0.3);
	...
	shadowhaunting: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 250, 0.3);
			scene.backgroundEffect('#000000', 250, 0.2, 400);
			scene.showEffect(attacker.sp, {
				x: attacker.x,
				y: attacker.y + 30,
	...
	shadowinversion: {
		anim(scene, [attacker, defender]) {
			...
			scene.showEffect('shadowshadowball3', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
				opacity: 0.3,
	...
	shadowmonsoon: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 900, 0.7);
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-raindance.jpg')`, 900, 0.3);
	...
	shadowmoon: {
		anim(scene, [attacker]) {
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/shadow-moon.png')`, 800, 0.8);
			scene.showEffect('shadowshine', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	shadowpanic: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 1300, 0.7);
			scene.showEffect('shadowshadowball', {
				x: attacker.x + 20,
				y: attacker.y - 60,
				z: attacker.behind(15),
	...
	shadowrage: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 1100, 0.7);
			scene.showEffect('angry', {
				x: attacker.x - 10,
				y: attacker.y + 50,
				z: attacker.z,
	...
	shadowrobbery: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 1700, 0.7);
			scene.showEffect('shadowshadowball', {
				x: attacker.x,
				y: attacker.y - 30,
				z: attacker.z,
	...
	shadowroulette: {
		anim(scene, [attacker]) {
			scene.backgroundEffect('#110131', 700, 0.7);
			scene.showEffect('shadowpointer', {
				x: attacker.x + 30,
				y: attacker.y + 30,
				z: attacker.z,
				scale: 0.4,
	...
	shadowsky: {
		anim: BattleOtherAnims.shadowdance.anim,
	},
	shadowslander: {
		anim: BattleOtherAnims.shadowsound.anim,
	},
	shadowslasher: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 700, 0.7);
			scene.showEffect('shadowleftslash', {
				x: defender.x - 10,
				y: defender.y - 10,
				z: defender.z,
				scale: 1.5,
	...
	shadowsnipe: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 700, 0.3);
			scene.showEffect('shadowshadowball2', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
	...
	shadowsorcery: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 900, 0.3);
			scene.showEffect('shadowwisp', {
				x: defender.x + 40,
				y: defender.y,
				z: defender.z,
	...
	shadowspell: {
		anim(scene, [attacker, defender]) {
			...
			scene.showEffect('shadowlightning', {
				x: defender.x + 15,
				y: defender.y,
				z: defender.z,
				scale: 0.5,
	...
	shadowspikes: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 700, 0.7);
			scene.showEffect('shadowcaltrop', {
				x: attacker.x,
				y: attacker.y,
				z: attacker.z,
				scale: 0.1,
	...
	shadowsqueeze: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 1200, 0.7);
			scene.showEffect('shadowshadowball', {
				x: defender.x,
				y: defender.y + 15,
				z: defender.z,
	...
	shadowstare: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 250, 0.7);
			scene.backgroundEffect('#000000', 250, 0.2, 400);
	...
	shadowsun: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/shadow-sun.png')`, 700, 0.8);
			scene.showEffect('shadowwisp2', {
				x: attacker.x + 40,
				y: attacker.y - 40,
				z: attacker.z,
	...
	shadowvolley: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 950, 0.7);
			scene.showEffect('shadowwisp', {
				x: defender.x - 100,
				y: defender.y,
				z: defender.z,
	...
	shadowwhiteout: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('#110131', 900, 0.7);
			scene.backgroundEffect(`url('https://${Config.routes.client}/fx/weather-hail.jpg')`, 900, 0.3);
	...
	shadowwreckage: {
		anim(scene, [attacker, ...defenders]) {
			scene.backgroundEffect('#110131', 600, 0.7);
			scene.$bg.delay(275);
			scene.$bg.animate({
				top: -90,
				bottom: 0,
	...
	shadowchill: {
		anim(scene, [attacker, defender]) {
			...
			for (let i = 0; i < 4; i++) {
				scene.showEffect('shadowicicle3', {
					x: attacker.x + xstep * (i + 1),
					y: attacker.y + ystep * (i + 1),
					z: attacker.z + zstep * (i + 1),
					scale: 1.5,
	...
	shadowdoomsday: {
		anim(scene) {
			scene.backgroundEffect('#110131', 300, 0.7);
			scene.backgroundEffect('#110131', 300, 0.9, 200);
		},
	},
	shadowtitan: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#390000 50%, #312a75)', 700, 0.7);
			scene.showEffect('shadowfireball3', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	shadowrainbow: {
		anim(scene, [attacker, defender]) {
			...
			scene.showEffect('shadowrainbow', {
				x: defender.x,
				y: defender.y - 5,
				z: defender.z,
				scale: 0.8,
	...
	mercilessmarinade: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect('linear-gradient(#2D0042 40%, #9A2FB8)', 600, 0.7, 1200);
			scene.showEffect('electroball', {
				x: defender.x,
				y: defender.y - 60,
				z: defender.z,
	...
	unifiedupsurge: {
		anim(scene, [attacker, ...defenders]) {
			...
			const defender = defenders[1] || defenders[0];
			scene.backgroundEffect('#000000', 300, 0.9);
			scene.backgroundEffect(`url('https://${Config.routes.client}/sprites/gen6bgs/bg-workout.png')`, 2000, 0.7, 300);
			scene.backgroundEffect('linear-gradient(#3E6EC2 20%, #3F1D0F', 2000, 0.6, 300);
			scene.backgroundEffect('#FFFFFF', 1000, 0.9, 2200);
			scene.showEffect('shine', {
				x: attacker.x - 10,
				y: attacker.y - 10,
	...
	antiquearabesque: {
		anim(scene, [attacker, ...defenders]) {
			...
			const defender = defenders[1] || defenders[0];
			scene.backgroundEffect('#000000', 300, 0.9);
			scene.backgroundEffect(`url('https://${Config.routes.client}/sprites/gen6bgs/bg-valerie.jpg')`, 2000, 0.7, 300);
			scene.backgroundEffect('linear-gradient(#AAE181 20%, #418B7B', 2000, 0.6, 300);
			scene.backgroundEffect('#FFFFFF', 1000, 0.9, 2200);
			scene.showEffect('shine', {
				x: attacker.x - 10,
				y: attacker.y - 10,
...
BattleMoveAnims['fieryblossom'] = {anim: BattleMoveAnims['flamecharge'].anim};
...
BattleMoveAnims['scold'] = {anim: BattleMoveAnims['hypervoice'].anim};
...
BattleMoveAnims['kappo'] = {anim: BattleMoveAnims['acupressure'].anim};
...
BattleMoveAnims['shadowmoss'] = {anim: BattleMoveAnims['shadowglow'].anim};
BattleMoveAnims['shadowcentrifuge'] = {anim: BattleMoveAnims['shadowwheel'].anim};
BattleMoveAnims['shadowdart'] = {anim: BattleMoveAnims['shadowsprint'].anim};
BattleMoveAnims['shadowmirage'] = {anim: BattleMoveAnims['shadowdesolation'].anim};
BattleMoveAnims['shadowwyrm'] = {anim: BattleMoveAnims['shadowglaze'].anim};
...
BattleMoveAnims['frenziedovergrowth'] = {anim: BattleMoveAnims['leafstorm'].anim};
BattleMoveAnims['blazingburnblast'] = {anim: BattleMoveAnims['blastburn'].anim};
...
BattleMoveAnims['orbitalshift'] = {anim: BattleMoveAnims['skillswap'].anim};
...
BattleMoveAnims['vendetta'] = {anim: BattleMoveAnims['nightslash'].anim};
