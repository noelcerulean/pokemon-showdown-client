...
class BattlePokemonSearch extends BattleTypedSearch<'pokemon'> {
	...
	getBaseResults(): SearchRow[] {
		...
		else if (format === 'anythinggoes' || format === 'hypnomons' || format.endsWith('ag') || format.startsWith('ag')) {
