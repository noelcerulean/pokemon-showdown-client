...
class BattleMoveSearch extends BattleTypedSearch<'move'> {
	...
	static readonly BAD_STRONG_MOVES = [
		'belch', 'burnup', 'crushclaw', 'doomdesire', 'dragonrush', 'dreameater', 'firepledge', 'flyingpress', 'futuresight', 'grasspledge', 'hyperbeam', 'hyperfang', 'hyperspacehole', 'jawlock', 'landswrath', 'lastresort', 'mistyexplosion', 'muddywater', 'nightdaze', 'pollenpuff', 'selfdestruct', 'shelltrap', 'skyuppercut', 'slam', 'strength', 'synchronoise', 'takedown', 'thrash', 'uproar', 'waterpledge',
	] as ID[] as readonly ID[];
