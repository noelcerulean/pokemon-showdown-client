...
class BattleMoveSearch extends BattleTypedSearch<'move'> {
	...
	static readonly GOOD_WEAK_MOVES = [
		'accelerock', 'acrobatics', 'aquajet', 'avalanche', 'bombsaway', 'bonemerang', 'bouncybubble', 'bulletpunch', 'buzzybuzz', 'circlethrow', 'clearsmog', 'cosmicspin', 'cumuloroll', 'doubleironbash', 'dragondarts', 'dragontail', 'endeavor', 'facade', 'firefang', 'flipturn', 'freezedry', 'frustration', 'geargrind', 'grassknot', 'gyroball', 'hex', 'icefang', 'iceshard', 'iciclespear', 'knockoff', 'lowkick', 'lunaticeyes', 'machpunch', 'naughtyornice', 'nightshade', 'nuzzle', 'onetwopunch', 'payday', 'pikapapow', 'propulsionshot', 'psychocut', 'pursuit', 'quickattack', 'rapidspin', 'return', 'rockblast', 'scorchingsands', 'seismictoss', 'shadowclaw', 'shadowsneak', 'sizzlyslide', 'spiderweb', 'sporeslash', 'storedpower', 'stormthrow', 'suckerpunch', 'superfang', 'surgingstrikes', 'sweep up', 'tailslap', 'toxicthread', 'tripleaxel', 'triplekick', 'twineedle', 'uturn', 'vaporize', 'veeveevolley', 'voltswitch', 'watershuriken', 'weatherball',
	] as ID[] as readonly ID[];
